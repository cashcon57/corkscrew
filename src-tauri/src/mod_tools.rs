...
fn fromsoft_tools() -> Vec<ModTool> {
    vec![
        ModTool {
            ...
            description: "FromSoft mod loader for Elden Ring, Dark Souls 3, and Armored Core VI. Disables EAC for offline modding. Install manually — auto-install disabled pending bottle-scoped install path validation.".into(),
            exe_names: vec![
