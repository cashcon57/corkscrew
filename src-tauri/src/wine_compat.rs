...
static REGISTRY: &[RegistryEntry] = &[
    ...
    RegistryEntry {
        mod_name_patterns: &["community shaders"],
        dll_patterns: &["communityshaders"],
        nexus_mod_id: Some(86492),
        severity: Severity::Crash,
        reason: "Community Shaders requires native D3D11 features unavailable in Wine/DXVK. Crashes on load.",
        workaround: Some("Use Corkscrew's Shader Conversion (Settings > Game > Shader Compatibility) to auto-convert to ENB."),
        alternative_mod_name: Some("ENB (via Corkscrew shader conversion)"),
        alternative_nexus_id: None,
    },
    RegistryEntry {
        ...
        reason: "ENB works on Wine but requires DXVK (not D3DMetal) and LinuxVersion=true in enblocal.ini.",
        workaround: Some("Corkscrew's shader conversion auto-configures DXVK + LinuxVersion=true for ENB."),
        alternative_mod_name: None,
        alternative_nexus_id: None,
    },
    RegistryEntry {
