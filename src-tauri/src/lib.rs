...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Update Checking
            commands::system::check_mod_updates,
            // Mod Tools
            ...
            // Platform Detection
            commands::system::get_platform_detail,
            commands::system::get_optimal_download_threads,
            // FOMOD
            commands::system::detect_fomod,
            commands::system::get_fomod_defaults,
            commands::system::get_fomod_files,
            // DLC Detection
            commands::system::check_dlc_status,
            // Integrity
            ...
            commands::system::scan_game_directory,
            commands::system::clean_game_directory,
            // Wabbajack Modlists
            ...
            commands::system::get_pinned_game_version,
            commands::system::pin_game_version,
            // Rollback & Snapshots
            commands::system::save_mod_version_cmd,
            commands::system::list_mod_versions_cmd,
            commands::system::rollback_mod_version,
            commands::system::cleanup_mod_versions,
            commands::system::create_mod_snapshot,
            commands::system::list_mod_snapshots,
            commands::system::delete_mod_snapshot,
            // Modlist Import/Export
            commands::system::export_modlist_cmd,
            commands::system::import_modlist_plan,
            commands::system::diff_modlists_cmd,
            commands::system::execute_modlist_import,
            // Disk Budget
            commands::system::get_disk_budget,
            commands::system::estimate_install_impact_cmd,
            commands::system::get_available_disk_space_cmd,
            // Staging Info
            commands::system::get_staging_info,
            commands::system::set_staging_directory,
            // INI Manager
            commands::system::get_ini_settings,
            commands::system::set_ini_setting,
            commands::system::get_ini_presets,
            commands::system::apply_ini_preset,
            commands::system::read_mod_file,
            commands::system::write_mod_file,
            // Wine Diagnostics
            ...
            // Game Lock
            commands::system::get_game_lock_status,
            commands::system::get_all_game_locks,
            commands::system::force_unlock_game,
            // Deploy Journal
            commands::system::get_deploy_journal_status,
            commands::system::heal_deployment,
            // FOMOD Recipes
            commands::system::save_fomod_recipe,
            commands::system::get_fomod_recipe,
            commands::system::list_fomod_recipes,
            commands::system::delete_fomod_recipe,
            commands::system::has_compatible_fomod_recipe,
            // Embedded Browser Webview
            commands::system::create_browser_webview,
            commands::system::resize_browser_webview,
            commands::system::close_browser_webview,
            commands::system::navigate_browser_webview,
            ...
            // Proton Detection
            commands::system::list_proton_versions,
            commands::system::get_recommended_proton,
            // Steam Integration
            commands::system::detect_steam,
            commands::system::check_steam_status,
            commands::system::add_to_steam,
            commands::system::remove_from_steam,
            commands::system::is_steam_deck,
            commands::system::steam_deck_warnings,
            // Steam Deck Profile
            commands::system::get_deck_profile,
            commands::system::get_deck_defaults,
            // NXM Handler
            ...
            commands::system::parse_instructions_cmd,
            commands::system::parse_instructions_llm_cmd,
            commands::system::parse_instructions_cloud_cmd,
            commands::system::validate_instruction_actions_cmd,
            commands::system::check_ollama_status_cmd,
            commands::system::get_recommended_models,
            commands::system::get_cloud_providers,
            commands::system::pull_ollama_model_cmd,
            commands::system::delete_ollama_model_cmd,
            commands::system::unload_ollama_model_cmd,
            commands::system::get_system_memory,
            commands::system::install_ollama,
            commands::system::start_ollama,
            commands::system::check_mlx_status,
            commands::system::install_mlx,
            commands::system::get_recommended_model,
            // LLM Chat
            ...
            // Vortex Extensions
            commands::system::vortex_fetch_extension,
            commands::system::vortex_refresh_extension,
            commands::system::vortex_list_cached_extensions,
            commands::system::vortex_list_available_extensions,
            commands::system::vortex_delete_cached_extension,
            commands::system::vortex_get_extension_detail,
            // Download Queue
            commands::system::get_download_queue,
            commands::system::get_download_queue_counts,
            commands::system::retry_download,
            commands::system::cancel_download,
            commands::system::clear_finished_downloads,
            // Notification Log
            commands::system::get_notification_log,
            commands::system::clear_notification_log,
            commands::system::log_notification,
            commands::system::get_notification_count,
            // Error Event Diagnostics
            commands::system::record_error_event_cmd,
            commands::system::get_error_summary,
